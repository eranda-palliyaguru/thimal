		  ...
		  ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="sales_rp_month.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>"><i
                                    class="fa fa-circle-o text-aqua "></i> Sales Month Report</a></li>
                    </ul>
                </li>
...
if ($user_lewal==1) { include('admin_sidebar.php'); }else { ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a rel="facebox" href="emty_loading.php"><i class="fa fa-circle-o text-aqua "></i> Emty
                                cylinder Loading</a></li>
                        <li><a rel="facebox" href="unloading.php"><i class="fa fa-circle-o text-aqua "></i>
                                Unloading</a></li>
                        <li><a href="loading_view.php?d1=<?php echo $date;?>&lorry=0"><i
                                    class="fa fa-circle-o text-aqua "></i> View Loading</a></li>
                        <li><a href="lorry_sales_view.php?d1=<?php echo $date;?>&lorry=0"><i
                                    class="fa fa-circle-o text-aqua "></i> View Lorry Sales</a></li>
                        </a>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a rel="facebox" href="distributor_lorry_pur.php"><i class="fa fa-circle-o text-aqua "></i>
                                Distributor Lorry Purchases</a></li>
                        <li><a href="purchase_view.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>"><i
                                    class="fa fa-circle-o text-aqua "></i> View Purchase</a></li>
                        </a>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="sales_credit.php"><i class="fa fa-circle-o text-aqua "></i> Credit Report</a></li>
                        <li><a
                                href="sales_credit_pay.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>&cus=all"><i
                                    class="fa fa-circle-o text-aqua "></i> Credit Payment Report</a></li>

                        <li><a href="bank_rp.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>"><i
                                    class="fa fa-circle-o text-aqua "></i> Bank Report</a></li>

                        <li><a href="pay_sum.php"><i class="fa fa-circle-o text-aqua "></i>Payment Summary </a></li>
                        <li><a href="loding_list.php?id=<?php echo $date;?>&lorry=0"><i
                                    class="fa fa-circle-o text-aqua "></i> Loading Report</a></li>
                        <li><a href="expenses_sum.php?d1=<?php echo $date;?>"><i class="fa fa-circle-o text-aqua "></i>
                                Expenses Report </a></li>
                        <li><a href="stock_rp.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>"><i
                                    class="fa fa-circle-o text-aqua "></i> Stock Report</a></li>
                        ...
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li><a
                                        href="sales_rp_special.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>&cus=all"><i
                                            class="fa fa-circle-o text-aqua "></i>Special Price Sales</a></li>
                                <li><a href="sales_all_rp.php?d1=<?php echo $date;?>"><i
                                            class="fa fa-circle-o text-aqua "></i> PNL Report </a></li>
                                <li><a href="damage_view.php"><i class="fa fa-circle-o text-aqua "></i> Damage
                                        Report</a></li>
                                <li><a href="stock_error.php"><i class="fa fa-circle-o text-aqua "></i> Stock Error</a>
                                </li>
                                <li><a href="purchase_view.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>"><i
                                            class="fa fa-circle-o text-aqua "></i> Purchase Report</a></li>
                                <li><a href="purchase_pay_rp.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>"><i
                                            class="fa fa-circle-o text-aqua "></i> Purchase Pay Report</a></li>
                                <li><a href="sales_dll_rp.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>&cus=all"><i
                                            class="fa fa-circle-o text-aqua "></i> Sales Delete Report</a></li>
                                <li><a href="new/go/bill_return_rp.php"><i class="fa fa-circle-o text-aqua "></i>
                                        Products Return Report</a></li>
                                <li><a href="sales_rp_month.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>"><i
                                            class="fa fa-circle-o text-aqua "></i> Sales Month Report</a></li>
                                <li><a href="vat_rp_s1.php?d1=<?php echo $date;?>&d2=<?php echo $date;?>"><i
                                            class="fa fa-circle-o text-aqua "></i>VAT Sales Report</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="sales_credit_back_date.php"><i class="fa fa-circle-o text-aqua "></i>
                                        Credit Report</a></li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a rel="facebox" href="damage_company.php"><i class="fa fa-circle-o text-aqua "></i>
                                    Sent Damage to Company</a></li>
                            <li><a rel="facebox" href="damage_receive.php"><i class="fa fa-circle-o text-aqua "></i>
                                    Damage Receive</a></li>
                            <li><a rel="facebox" href="damage_customer.php"><i class="fa fa-circle-o text-aqua "></i>
                                    Sent Damage to Customer</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="gift.php"><i class="fa fa-circle-o text-aqua "></i> Add New Gift Voucher</a>
                            </li>
                            <li><a rel="facebox" href="gift_company.php"><i class="fa fa-circle-o text-aqua "></i> Sent
                                    Voucher to Company</a></li>
                            <li><a rel="facebox" href="gift_receive.php"><i class="fa fa-circle-o text-aqua "></i>
                                    Voucher Receive</a></li>

                            <li><a href="gift_view.php"><i class="fa fa-circle-o text-aqua "></i> View Gift Voucher</a>
                            </li>
                            </a>
                        </ul>
                    </li>
