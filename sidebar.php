	...
	<li><a href="lorry_sales_view.php?d1=<?php echo $date;?>&lorry=0"><i class="fa fa-circle-o text-aqua "></i> View Lorry Sales</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="new/go/sales_rp.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>&cus=all"><i class="fa fa-circle-o text-aqua "></i> Sales Report new</a></li>
             <li><a href="sales_rp_customer_group.php"><i class="fa fa-circle-o text-aqua "></i> Sales Report-Customer</a></li>
