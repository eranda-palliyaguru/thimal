...
var p_type = c_no = document.getElementById('p_type').value;
		
		if( p_type == 'chq'){
		
  var c_no = document.getElementById('chq_no').value;
  if (c_no == "") {	  
   document.getElementById("chq_no1").innerHTML = "Fill This";  
	  $('input[name=com]').show();
	  return false;
  }
  ...
  if (bank == "") {	  
   document.getElementById("bank1").innerHTML = "Fill This";  
	  $('input[name=com]').show();
	  return false;
  }
		
  var chq_amount = document.getElementById('chq_amount').value;
  if (chq_amount == "") {	  
   document.getElementById("chq_amount1").innerHTML = "Fill This";  
	  $('input[name=com]').show();
	  return false;
  }
 ...
 var chq_date = document.getElementById('chq_date').value;
  if (chq_date == "") {	  
   document.getElementById("chq_date1").innerHTML = "Fill This";  
	  $('input[name=com]').show();
	  return false;
  }
 ...
 var cash_amount = document.getElementById('cash_amount').value;
  if (cash_amount == "") {	  
   document.getElementById("cash_amount1").innerHTML = "Fill This";  
	  $('input[name=com]').show();
	  return false;
  }		
		
		
var chq = document.getElementById('chq_date').value;
var chq_date = chq.search("_");		
		if (chq_date > 0){
		 document.getElementById("chq_date1").innerHTML = "Fill This";	  
	  $('input[name=com]').show();
	  return false;	
