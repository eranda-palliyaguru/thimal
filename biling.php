        ...
        <div class="box-body">
          <div class="row">
			...
			<form method="post" action="incoming.php">	
				<input type="hidden" value='<?php echo $invoice=$_GET['invo']; ?>'  name="invo"  >
				<input type="hidden" value='<?php echo $id=$_GET['id']; ?>'  name="id"  >
				<input type="hidden" value=''  name="lorry"  >
                ...
                <select class="form-control select2" name="products" style="width: 100%;" autofocus >
				  ...
				  <?php
                $result = $db->prepare("SELECT * FROM loading_list WHERE loading_id='$id' AND action='load' ");
...
<a href="other_pay.php?id=<?php echo $_GET['invo']; ?>"><button class="btn btn-primary"> Payment</button></a>
