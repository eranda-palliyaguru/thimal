...
if($qty>0){
$sql = "INSERT INTO sales_list (product_id,name,qty,price,amount,profit,date,invoice_no) VALUES (:a,:b,:c,:d,:e,:f,:g,:invo)";
$ql = $db->prepare($sql);
$ql->execute(array(':a'=>$pro_id,':b'=>$name,':c'=>$qty,':d'=>$price,':e'=>$amount,':f'=>$profit,':g'=>$date,':invo'=>$invo));
} }
		}
