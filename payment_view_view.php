...
<small class="label pull-right bg-green"><h5>Total Rs.<?php echo $amount;?></h5></small>
		 
     <small class="label pull-left bg-red"><h5>Balance Rs.<?php echo $balance=$amount-$pay_amount;?></h5></small>
		<br><br><br>
