    ...
    <section class="content">
      ...
      <div class="box box-warning ">
		...
		<div class="form-group">
         <a  href="unloading_view2.php?d=<?php echo date("Y/m/d"); ?>&lorry_no=<?php echo $_GET['lorry'];?>"><button  class=" btn btn-info" style="width: 123px; height:35px; margin-:-8px;margin-left:8px;" >
  Next
 </button></a>     
		<form method="post" action="unload_saveloading.php">
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
	...
	<?php
		...
		<label>Lorry No.<a class="btn btn-info btn-xs"><i> <?php echo $_GET['lorry']; ?></i></a></label>
		<label>Rep.<a class="btn btn-warning btn-xs"><i> <?php echo $_GET['rep']; ?></i></a></label>
		<label>Root.<a class="btn btn-danger btn-xs"><i> <?php echo $_GET['root']; ?></i></a></label>
</h5>
