	 ...
	 <div class="col-md-4">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              ...
              <!-- /.widget-user-image -->
              <h2 class="widget-user-username">Kaluthara Yard</h2>
            ...
            <div class="box-footer no-padding">
			  ...
			  $result = $db->prepare("SELECT * FROM products WHERE product_name='' ");
                ...
                for($i=0; $row = $result->fetch(); $i++){
					...
					?>
                <li><a href="#"><?php echo $row['gen_name']; ?> <span class="pull-right badge bg-green"><?php echo $row['qty']; ?></span></a></li>
                <?php } ?>
              </ul>
            </div>
          </div>
            ...
            <div class="box-footer no-padding">
			  ...
			  $result = $db->prepare("SELECT * FROM products WHERE product_name>=1  ");
                ...
                for($i=0; $row = $result->fetch(); $i++){
					...
					?>
                <li><a href="#"><?php echo $row['gen_name']; ?> <span class="pull-right badge bg-red"><?php echo $row['qty2']; ?></span></a></li>
                <?php } ?>
				<?php
			  $result = $db->prepare("SELECT * FROM products WHERE product_name='' ");
                ...
                for($i=0; $row = $result->fetch(); $i++){
					...
					?>
                <li><a href="#"><?php echo $row['gen_name']; ?> <span class="pull-right badge bg-green"><?php echo $row['qty2']; ?></span></a></li>
                <?php } ?>
                </ul>
            </div>
          </div>
	 ...
	 <div class="col-md-4">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-teal">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username"><?php echo $no;?></h3>
              <h5 class="widget-user-desc"></h5>
            </div>
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
			  <?php
			  $result1 = $db->prepare("SELECT * FROM loading WHERE action='load' AND lorry_no='$no' ");
                ...
                for($i=0; $row1 = $result1->fetch(); $i++){
					...
					?>
                <li><a href="#"><?php echo $row1['product_name']; ?> <span class="pull-right badge "><?php echo $row1['qty_sold']; ?></span>
				<span class="pull-right badge bg-yellow"><?php echo $row1['qty']; ?></span>
				</a></li>
                <?php } ?>
