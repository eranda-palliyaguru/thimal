   ...
   <div class="form-group" id='credit_pay' style="display:none;">
	...
	<input class="btn btn-info" type="submit" name="com" value="print" >
     ...
     <br>
         ...
         <div class="input-group"> 
           <input type="text" name="bank" class="form-control pull-right" required>
       </div>
			 <label for="exampleInputPassword1">Amount</label>
         <div class="input-group"> 
           <input type="text" name="chq_amount" class="form-control pull-right" autocomplete="off" required>
       </div>
			  <label for="exampleInputPassword1">Date</label>
         <div class="input-group"> 
           <input type="text" name="chq_date" class="form-control pull-right" autocomplete="off" data-inputmask='"mask": "9999-99-99"' data-mask required>
       </div>
      <br>
