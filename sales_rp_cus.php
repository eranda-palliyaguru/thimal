 ...
 <script type="text/javascript">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
     ...
     <form action="sales_rp_cus.php" method="get">   
	<center>
...
if($cus=="all"){
	...
	$result2 = $db->prepare("SELECT * FROM sales WHERE  customer_id='$cus' and action='1' and date BETWEEN '$d1' and '$d2' ORDER by transaction_id DESC");
}
