  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-danger">
		...
		<form method="post" action="save_dis_purchase2.php">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
				...
				<input type="hidden" value='<?php //echo $_GET['yard']; ?>'  name="yard"  >
				

				
				
                <select class="form-control select2" multiple="1" data-placeholder="Select a Lorry" name="products" style="width: 100%;" autofocus >
