...
<link rel="stylesheet" href="datepicker.css"
 ...
 <script type="text/javascript">
  ...
  <!-- Content Wrapper. Contains page content -->
   ...
   <br><div class="input-group margin">
    ...
    <input data-provide="datepicker" data-date-format="yyyy-mm-dd"  type="text" class="form-control" name="date" style="width: 150px"   value="<?php echo date("Y-m-d"); ?>" autocomplete="off"/>
	</form>  </div>
...
<?php 
	$date=$_GET['date'];
	$result = $db->prepare("SELECT * FROM bank WHERE  date='$date'  ");
